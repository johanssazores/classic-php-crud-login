...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group">
        	<input type="email" class="form-control" name="email" placeholder="Enter your Email id" required="true">
				...
				<div class="form-group">
        	<input type="text" class="form-control" name="username" placeholder="Enter your Username" required="true">
        </div>
				<div class="form-group">
	...
	<div class="text-center">View Already Added Data!!  <a href="user-list.php">View</a></div>
</div>
